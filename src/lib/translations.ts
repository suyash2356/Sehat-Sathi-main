...
export const translations = {
  en: {
    ...
    governmentSchemes: {
      ...
      mapTimings: 'Timings',
      mapContact: 'Contact',
      mySchemesTitle: 'Find Schemes for You',
      mySchemesDescription: 'Answer a few questions to find out which government health schemes you might be eligible for.',
      mySchemesButton: 'Find My Schemes',
      mySchemesFormTitle: 'Tell us about yourself',
      mySchemesFormAge: 'Your Age',
      mySchemesFormGender: 'Your Gender',
      mySchemesFormGenderMale: 'Male',
      mySchemesFormGenderFemale: 'Female',
      mySchemesFormGenderOther: 'Other',
      mySchemesFormState: 'Your State',
      mySchemesFormDistrict: 'Your District',
      mySchemesFormSubmit: 'Show My Schemes',
      mySchemesResultsTitle: 'Schemes based on your profile',
      mySchemesResetButton: 'Show All Schemes',
      mySchemesNoResults: 'No specific schemes found based on your profile. Showing all available schemes.',
    ...
    map: {
      findAndBook: 'Find & Book',
      myRequests: 'My Requests',
      findADoctor: 'Find a Doctor',
      searchPlaceholder: 'Search doctor, hospital, village...',
      ...
      doctorsFound: 'Doctors Found ({count})',
      offline: 'Offline',
      filters: 'Filters',
      close: 'Close',
      bookAppointment: 'Book Appointment',
      selectDoctorStart: 'Select a doctor on the map to start booking.',
      ...
      issuePlaceholder: 'Describe symptoms',
      callType: 'Call Type',
      selectCallType: 'Select call type',
      videoCall: 'Video Call',
      voiceCall: 'Voice Call',
      inPerson: 'In-Person',
      onlyInPerson: 'Only in-person visits available.',
      urgentCall: 'Urgent: Call Now',
      notAvailableHospitals: 'Not available for hospitals',
      privacyMode: 'Privacy Mode',
      privacySubtext: "Doctor won't see your real name.",
      date: 'Date',
      time: 'Time',
      requestUrgent: 'Request Urgent Walk-in',
      startEmergency: 'Start Emergency Call',
      scheduleAppointment: 'Schedule Appointment',
      noDoctorSelected: 'No Doctor Selected',
      noDoctorDesc: 'Please select a doctor/hospital before booking.',
      loginRequired: 'Login Required',
      loginRequiredDesc: 'You must be logged in to book an appointment.',
      timeSlotUnavailable: 'Time Slot Unavailable',
      timeSlotDesc: 'The doctor already has an appointment booked at this exact time. Please choose another time.',
      requestSent: 'Request Sent',
      immediateSent: 'Your immediate call request has been sent. Please wait for the doctor to accept.',
      scheduledSent: 'Appointment scheduled. Waiting for doctor\'s approval.',
      error: 'Error',
      failedBooking: 'Failed to create appointment.',
      placeholder: {
        select: 'Select a doctor or hospital',
        viewDetails: 'from the map to view details before booking',
      },
      doctorCard: {
      ...
      hospitalCard: {
        verified: 'Government Verified Hospital',
        specialization: 'Specialization',
        consultation: 'Consultation',
        freeGov: 'Free (Government)',
        contact: 'Contact Number',
        typeLabel: 'Type',
        govHospital: 'Government Hospital',
        aboutHospital: 'About Hospital',
        notableStaff: 'Notable Staff',
        doctorsAtHospital: 'Doctors at this Hospital ({count})',
        noDoctorsFound: 'No registered doctors found at this hospital yet.',
        inPersonOnly: 'Appointment type for government hospitals is In-Person visit only.',
      },
      days: {
        Monday: 'Monday',
        Tuesday: 'Tuesday',
      ...
      requests: {
        ...
        noRequestsDesc: 'Find a doctor on the map and book your first appointment.',
        findDoctorButton: 'Find a Doctor',
        noFilterMatch: 'No appointment history matches the selected filter status.',
        status: {
        ...
        callLive: 'Your call with Dr. {name} is live',
        doctorWaiting: 'The doctor is waiting for you to join the session.',
        joinCall: 'Join Call →',
        ...
        prescriptionPending: 'Prescription Pending',
        cancelDialog: {
          title: 'Cancel Appointment',
          description: 'Are you sure you want to cancel your appointment with Dr. {name}?',
          reasonLabel: 'Reason for cancellation *',
          reasonPlaceholder: 'Please write your reason here...',
          requiredNote: '(min 10 characters, required)',
          keepButton: 'Keep Appointment',
          cancelButton: 'Cancel Appointment',
        },
        loginPrompt: 'Please log in',
        loginDesc: 'You need to be logged in to view your booking requests.',
      ...
      prescription: {
        ...
        ePrescription: 'Sehat Sathi - E-Prescription',
        ...
        notes: 'Notes',
        stampNotAvailable: 'Stamp not available',
        signatureNotAvailable: 'Signature not available',
        footerNote: '* This prescription is digitally issued via Sehat Sathi. Verify at sehat-sathi.com',
        close: 'Close',
        yearsShort: 'y',
      },
      validation: {
        ...
        issueMin: 'Please describe your issue in at least 10 characters.',
        ageMin: 'Age must be at least 1.',
        ageMax: 'Please enter a valid age.',
        genderRequired: 'Please select a gender.',
        callTypeRequired: 'Please select a call type.',
        dateTimeRequired: 'Date and time are required for scheduled calls.',
      }
    }
  },
  hi: {
    ...
    governmentSchemes: {
      ...
      mapTimings: 'समय',
      mapContact: 'संपर्क',
      mySchemesTitle: 'आपके लिए योजनाएं खोजें',
      mySchemesDescription: 'यह जानने के लिए कुछ सवालों के जवाब दें कि आप किन सरकारी स्वास्थ्य योजनाओं के लिए पात्र हो सकते हैं।',
      mySchemesButton: 'मेरी योजनाएं खोजें',
      mySchemesFormTitle: 'हमें अपने बारे में बताएं',
      mySchemesFormAge: 'आपकी उम्र',
      mySchemesFormGender: 'आपका लिंग',
      mySchemesFormGenderMale: 'पुरुष',
      mySchemesFormGenderFemale: 'महिला',
      mySchemesFormGenderOther: 'अन्य',
      mySchemesFormState: 'आपका राज्य',
      mySchemesFormDistrict: 'आपका जिला',
      mySchemesFormSubmit: 'मेरी योजनाएं दिखाएं',
      mySchemesResultsTitle: 'आपकी प्रोफ़ाइल के आधार पर योजनाएं',
      mySchemesResetButton: 'सभी योजनाएं दिखाएं',
      mySchemesNoResults: 'आपकी प्रोफ़ाइल के आधार पर कोई विशिष्ट योजना नहीं मिली। सभी उपलब्ध योजनाएं दिखा रहा है।',
    ...
    map: {
      findAndBook: 'खोजें और बुक करें',
      myRequests: 'मेरे अनुरोध',
      findADoctor: 'डॉक्टर खोजें',
      searchPlaceholder: 'डॉक्टर, अस्पताल, गांव खोजें...',
      ...
      doctorsFound: 'डॉक्टर मिले ({count})',
      offline: 'ऑफलाइन',
      filters: 'फिल्टर',
      close: 'बंद करें',
      bookAppointment: 'अपॉइंटमेंट बुक करें',
      selectDoctorStart: 'बुकिंग शुरू करने के लिए मानचित्र पर डॉक्टर चुनें।',
      bookingWith: 'इनके साथ बुकिंग: ',
      fullName: 'पूरा नाम',
      ...
      issuePlaceholder: 'लक्षणों का वर्णन करें',
      callType: 'कॉल का प्रकार',
      selectCallType: 'कॉल प्रकार चुनें',
      videoCall: 'वीडियो कॉल',
      voiceCall: 'वॉयस कॉल',
      inPerson: 'व्यक्तिगत रूप से',
      onlyInPerson: 'केवल अस्पताल में मुलाकात उपलब्ध है।',
      urgentCall: 'तत्काल: अभी कॉल करें',
      notAvailableHospitals: 'अस्पतालों के लिए उपलब्ध नहीं',
      privacyMode: 'गोपनीयता मोड',
      privacySubtext: "डॉक्टर आपका असली नाम नहीं देख पाएंगे।",
      date: 'तारीख',
      time: 'समय',
      requestUrgent: 'तत्काल वॉक-इन का अनुरोध करें',
      startEmergency: 'आपातकालीन कॉल शुरू करें',
      scheduleAppointment: 'अपॉइंटमेंट शेड्यूलिंग',
      noDoctorSelected: 'कोई डॉक्टर नहीं चुना गया',
      noDoctorDesc: 'कृपया बुकिंग से पहले डॉक्टर/अस्पताल चुनें।',
      loginRequired: 'लॉग इन आवश्यक',
      loginRequiredDesc: 'अपॉइंटमेंट बुक करने के लिए आपको लॉग इन करना होगा।',
      timeSlotUnavailable: 'समय उपलब्ध नहीं है',
      timeSlotDesc: 'डॉक्टर के पास पहले से ही इस समय पर अपॉइंटमेंट बुक है। कृपया दूसरा समय चुनें।',
      requestSent: 'अनुरोध भेजा गया',
      immediateSent: 'आपका तत्काल कॉल अनुरोध भेज दिया गया है। कृपया डॉक्टर के स्वीकार करने की प्रतीक्षा करें।',
      scheduledSent: 'अपॉइंटमेंट शेड्यूल किया गया। डॉक्टर की मंजूरी का इंतजार है।',
      error: 'त्रुटि',
      failedBooking: 'अपॉइंटमेंट बनाने में विफल।',
      placeholder: {
        select: 'डॉक्टर या अस्पताल चुनें',
        viewDetails: 'बुकिंग से पहले विवरण देखने के लिए मानचित्र से चुनें',
      },
      doctorCard: {
        ...
        closed: 'बंद',
        about: 'बारे में',
        free: 'नि:शुल्क परामर्श',
      },
      hospitalCard: {
        verified: 'सरकारी सत्यापित अस्पताल',
        specialization: 'विशेषज्ञता',
        consultation: 'परामर्श',
        freeGov: 'मुफ्त (सरकारी)',
        contact: 'संपर्क नंबर',
        typeLabel: 'प्रकार',
        govHospital: 'सरकारी अस्पताल',
        aboutHospital: 'अस्पताल के बारे में',
        notableStaff: 'प्रमुख स्टाफ',
        doctorsAtHospital: 'इस अस्पताल में डॉक्टर ({count})',
        noDoctorsFound: 'अभी तक इस अस्पताल में कोई पंजीकृत डॉक्टर नहीं मिला।',
        inPersonOnly: 'सरकारी अस्पतालों के लिए अपॉइंटमेंट प्रकार केवल व्यक्तिगत मुलाकात है।',
      },
      days: {
        Monday: 'सोमवार',
        Tuesday: 'मंगलवार',
      ...
      requests: {
        title: 'मेरे अनुरोध',
        filterLabel: 'अनुरोधों को फ़िल्टर करें:',
        allRequests: 'सभी अनुरोध',
        everyRequest: 'हर अनुरोध',
        pending: 'लंबित',
        accepted: 'स्वीकार और अनुसूचित',
        completed: 'पूरा हुआ',
        cancelled: 'रद्द',
        declined: 'अस्वीकार',
        noRequests: 'अभी तक कोई बुकिंग अनुरोध नहीं',
        noRequestsDesc: 'मानचित्र पर डॉक्टर ढूंढें और अपना पहला अपॉइंटमेंट बुक करें।',
        findDoctorButton: 'डॉक्टर खोजें',
        noFilterMatch: 'चुने गए फ़िल्टर की स्थिति से कोई अपॉइंटमेंट इतिहास मेल नहीं खाता।',
        status: {
          awaiting: '⏳ प्रतिक्रिया की प्रतीक्षा है',
        ...
        callLive: 'डॉ. {name} के साथ आपकी कॉल लाइव है',
        doctorWaiting: 'डॉक्टर आपके सत्र में शामिल होने की प्रतीक्षा कर रहे हैं।',
        joinCall: 'कॉल में शामिल हों →',
        specialist: 'विशेषज्ञ',
        immediate: 'तत्काल (अभी कॉल करें)',
        cancelRequest: 'अनुरोध रद्द करें',
        cancel: 'रद्द करें',
        viewPrescription: 'प्रिस्क्रिप्शन देखें',
        prescriptionPending: 'प्रिस्क्रिप्शन लंबित है',
        cancelDialog: {
          title: 'अपॉइंटमेंट रद्द करें',
          description: 'क्या आप निश्चित रूप से डॉ. {name} के साथ अपना अपॉइंटमेंट रद्द करना चाहते हैं?',
          reasonLabel: 'रद्द करने का कारण *',
          reasonPlaceholder: 'कृपया अपना कारण यहाँ लिखें...',
          requiredNote: '(न्यूनतम 10 अक्षर, आवश्यक)',
          keepButton: 'अपॉइंटमेंट रखें',
          cancelButton: 'अपॉइंटमेंट रद्द करें',
        },
        loginPrompt: 'कृपया लॉगिन करें',
        loginDesc: 'अपने बुकिंग अनुरोध देखने के लिए आपको लॉगिन करना होगा।',
        loginButton: 'लॉगिन / साइन अप',
        startsIn: '{time} में शुरू होगा',
        startingSoon: 'जल्द ही शुरू हो रहा है',
        overdue: 'देरी / अभी हो रहा है',
      },
      prescription: {
        title: 'प्रिस्क्रिप्शन विवरण',
        download: 'पीडीएफ डाउनलोड करें',
        ePrescription: 'सेहत साथी - ई-प्रिस्क्रिप्शन',
        consultingPhysician: 'परामर्श चिकित्सक',
        digitalConsultation: 'डिजिटल परामर्श',
        ...
        noMedications: 'कोई दवा निर्धारित नहीं की गई है।',
        notes: 'नोट्स',
        stampNotAvailable: 'स्टाम्प उपलब्ध नहीं है',
        signatureNotAvailable: 'हस्ताक्षर उपलब्ध नहीं है',
        footerNote: '* यह प्रिस्क्रिप्शन सेहत साथी के माध्यम से डिजिटल रूप से जारी किया गया है। sehat-sathi.com पर सत्यापित करें',
        close: 'बंद करें',
        yearsShort: 'वर्ष',
      },
      validation: {
        ...
        issueMin: 'कृपया अपनी समस्या का कम से कम 10 अक्षरों में वर्णन करें।',
        ageMin: 'आयु कम से कम 1 होनी चाहिए।',
        ageMax: 'कृपया एक मान्य आयु दर्ज करें।',
        genderRequired: 'कृपया लिंग चुनें।',
        callTypeRequired: 'कृपया कॉल का प्रकार चुनें।',
        dateTimeRequired: 'अनुसूचित कॉल के लिए तिथि और समय आवश्यक हैं।',
      }
    }
  },
  mr: {
    ...
    landing: {
      ...
      features: [
        ...
        {
          title: 'रुग्णालय आणि योजना लोकेटर',
    ...
    governmentSchemes: {
      ...
      mapTimings: 'वेळा',
      mapContact: 'संपर्क',
      mySchemesTitle: 'तुमच्यासाठी योजना शोधा',
      mySchemesDescription: 'तुम्ही कोणत्या सरकारी आरोग्य योजनांसाठी पात्र आहात हे शोधण्यासाठी काही प्रश्नांची उत्तरे द्या।',
      mySchemesButton: 'माझ्या योजना शोधा',
      mySchemesFormTitle: 'आम्हाला तुमच्याबद्दल सांगा',
      mySchemesFormAge: 'तुमचे वय',
      mySchemesFormGender: 'तुमचे लिंग',
      mySchemesFormGenderMale: 'पुरुष',
      mySchemesFormGenderFemale: 'स्त्री',
      mySchemesFormGenderOther: 'इतर',
      mySchemesFormState: 'तुमचे राज्य',
      mySchemesFormDistrict: 'तुमचा जिल्हा',
      mySchemesFormSubmit: 'माझ्या योजना दर्शवा',
      mySchemesResultsTitle: 'तुमच्या प्रोफाइलवर आधारित योजना',
      mySchemesResetButton: 'सर्व योजना दर्शवा',
      mySchemesNoResults: 'तुमच्या प्रोफाइलवर आधारित कोणतीही विशिष्ट योजना आढळली नाही. सर्व उपलब्ध योजना दर्शवित आहे।',
    ...
    map: {
      findAndBook: 'शोधा आणि बुक करा',
      myRequests: 'माझ्या विनंत्या',
      findADoctor: 'डॉक्टर शोधा',
      searchPlaceholder: 'डॉक्टर, रुग्णालय, गाव शोधा...',
      ...
      doctorsFound: 'डॉक्टर सापडले ({count})',
      offline: 'ऑफलाइन',
      filters: 'फिल्टर',
      close: 'बंद करा',
      bookAppointment: 'अपॉइंटमेंट बुक करा',
      selectDoctorStart: 'बुकिंग सुरू करण्यासाठी नकाशावर डॉक्टर निवडा।',
      bookingWith: 'यांच्यासोबत बुकिंग: ',
      fullName: 'पूर्ण नाव',
      fullNamePlaceholder: 'उदा., रमेश कुमार',
      age: 'वय',
      agePlaceholder: '२५',
      ...
      issuePlaceholder: 'लक्षणे सांगा',
      callType: 'कॉलचा प्रकार',
      selectCallType: 'कॉल प्रकार निवडा',
      videoCall: 'व्हिडिओ कॉल',
      voiceCall: 'व्हॉइस कॉल',
      inPerson: 'वैयक्तिकरीत्या',
      onlyInPerson: 'केवळ रुग्णालयात भेट उपलब्ध आहे।',
      urgentCall: 'त्वरित: आता कॉल करा',
      notAvailableHospitals: 'रुग्णालयांसाठी उपलब्ध नाही',
      privacyMode: 'गोपनीयता मोड',
      privacySubtext: "डॉक्टर तुमचे खरे नाव पाहू शकणार नाहीत।",
      date: 'तारीख',
      time: 'वेळ',
      requestUrgent: 'त्वरित वॉक-इन विनंती करा',
      startEmergency: 'आणीबाणीचा कॉल सुरू करा',
      scheduleAppointment: 'अपॉइंटमेंट शेड्यूल करा',
      noDoctorSelected: 'कोणताही डॉक्टर निवडलेला नाही',
      noDoctorDesc: 'कृपया बुकिंग करण्यापूर्वी डॉक्टर/रुग्णालय निवडा।',
      loginRequired: 'लॉगइन आवश्यक',
      loginRequiredDesc: 'अपॉइंटमेंट बुक करण्यासाठी तुम्हाला लॉगइन करावे लागेल।',
      timeSlotUnavailable: 'वेळ उपलब्ध नाही',
      timeSlotDesc: 'डॉक्टरकडे आधीच या वेळेत अपॉइंटमेंट बुक आहे। कृपया दुसरी वेळ निवडा।',
      requestSent: 'विनंती पाठवली',
      immediateSent: 'तुमची त्वरित कॉल विनंती पाठवली गेली आहे। कृपया डॉक्टरच्या स्वीकृतीची प्रतीक्षा करा।',
      scheduledSent: 'अपॉइंटमेंट शेड्यूल केली। डॉक्टरच्या मंजुरीची प्रतीक्षा आहे।',
      error: 'त्रुटी',
      failedBooking: 'अपॉइंटमेंट तयार करण्यात अपयश।',
      placeholder: {
        select: 'डॉक्टर किंवा रुग्णालय निवडा',
        viewDetails: 'बुकिंगपूर्वी तपशील पाहण्यासाठी नकाशावरून निवडा',
      },
      doctorCard: {
        verified: 'सत्यापित डॉक्टर',
        fee: 'परामर्श शुल्क',
        ...
        closed: 'बंद',
        about: 'बद्दल',
        free: 'विनामूल्य आरोग्य सल्ला',
      },
      hospitalCard: {
        verified: 'शासकीय सत्यापित रुग्णालय',
        specialization: 'विशेषज्ञता',
        consultation: 'परामर्श',
        freeGov: 'मोफत (शासकीय)',
        contact: 'संपर्क क्रमांक',
        typeLabel: 'प्रकार',
        govHospital: 'शासकीय रुग्णालय',
        aboutHospital: 'रुग्णालयाबद्दल',
        notableStaff: 'प्रमुख कर्मचारी (स्टाफ)',
        doctorsAtHospital: 'या रुग्णालयातील डॉक्टर ({count})',
        noDoctorsFound: 'या रुग्णालयात अद्याप कोणतेही नोंदणीकृत डॉक्टर सापडले नाहीत।',
        inPersonOnly: 'शासकीय रुग्णालयांसाठी अपॉइंटमेंट प्रकार केवळ वैयक्तिक भेट आहे।',
      },
      days: {
        Monday: 'सोमवार',
        Tuesday: 'मंगळवार',
      ...
      requests: {
        ...
        filterLabel: 'विनंत्या फिल्टर करा:',
        allRequests: 'सर्व विनंत्या',
        everyRequest: 'प्रत्येक विनंती',
        pending: 'प्रलंबित',
        accepted: 'स्वीकारलेले आणि नियोजित',
        completed: 'पूर्ण झाले',
        cancelled: 'रद्द',
        declined: 'अकारले',
        noRequests: 'अद्याप कोणतीही बुकिंग विनंती नाही',
        noRequestsDesc: 'नकाशावर डॉक्टर शोधा आणि तुमची पहिली अपॉइंटमेंट बुक करा।',
        findDoctorButton: 'डॉक्टर शोधा',
        noFilterMatch: 'निवडलेल्या फिल्टर स्थितीशी कोणताही अपॉइंटमेंट इतिहास जुळत नाही।',
        status: {
          awaiting: '⏳ प्रतिसादाची प्रतीक्षा आहे',
        ...
        callLive: 'डॉ. {name} सोबतचा तुमचा कॉल लाइव्ह आहे',
        doctorWaiting: 'डॉक्टर तुम्ही सत्रात सामील होण्याची प्रतीक्षा करत आहेत।',
        joinCall: 'कॉलमध्ये सामील व्हा →',
        specialist: 'विशेषज्ञ',
        immediate: 'त्वरित (आता कॉल करा)',
        cancelRequest: 'विनंती रद्द करा',
        cancel: 'रद्द करा',
        viewPrescription: 'प्रिस्क्रिप्शन पहा',
        prescriptionPending: 'प्रिस्क्रिप्शन प्रलंबित आहे',
        cancelDialog: {
          title: 'अपॉइंटमेंट रद्द करा',
          description: 'तुम्ही नक्की डॉ. {name} सोबतची तुमची अपॉइंटमेंट रद्द करू इच्छिता?',
          reasonLabel: 'रद्द करण्याचे कारण *',
          reasonPlaceholder: 'कृपया तुमचे कारण येथे लिहा...',
          requiredNote: '(किमान १० अक्षरे, आवश्यक)',
          keepButton: 'अपॉइंटमेंट ठेवा',
          cancelButton: 'अपॉइंटमेंट रद्द करा',
        },
        loginPrompt: 'कृपया लॉगइन करा',
        loginDesc: 'तुमच्या बुकिंग विनंत्या पाहण्यासाठी तुम्हाला लॉगइन करणे आवश्यक आहे।',
        loginButton: 'लॉगइन / साइन अप',
        startsIn: '{time} मध्ये सुरू होईल',
        startingSoon: 'लवकरच सुरू होत आहे',
        overdue: 'उशिर / आता सुरू आहे',
      },
      prescription: {
        title: 'प्रिस्क्रिप्शन तपशील',
        download: 'पीडीएफ डाउनलोड करा',
        ePrescription: 'सेहत साथी - ई-प्रिस्क्रिप्शन',
        consultingPhysician: 'सल्लागार चिकित्सक',
        digitalConsultation: 'डिजिटल सल्लामसलत',
        ...
        noMedications: 'कोणतीही औषधे लिहून दिली नाहीत।',
        notes: 'नोट्स',
        stampNotAvailable: 'शिक्का उपलब्ध नाही',
        signatureNotAvailable: 'स्वाक्षरी उपलब्ध नाही',
        footerNote: '* हे प्रिस्क्रिप्शन सेहत साथी द्वारे डिजिटल स्वरूपात जारी केले आहे। sehat-sathi.com वर पडताळणी करा',
        close: 'बंद करा',
        yearsShort: 'वर्षे',
      },
      validation: {
        nameMin: 'नाव किमान २ अक्षरांचे असावे।',
        phoneInvalid: 'कृपया वैध १०-अंकी फोन नंबर प्रविष्ट करा।',
        issueMin: 'कृपया तुमच्या समस्येचे किमान १० अक्षरांमध्ये वर्णन करा।',
        ageMin: 'वय किमान १ असावे।',
        ageMax: 'कृपया वैध वय प्रविष्ट करा।',
        genderRequired: 'कृपया लिंग निवडा।',
        callTypeRequired: 'कृपया कॉल प्रकार निवडा।',
        dateTimeRequired: 'नियोजित कॉलसाठी तारीख आणि वेळ आवश्यक आहे।',
      }
    }
  },
};
